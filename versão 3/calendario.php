...
function MostreCalendario( $mes, $ano)
{
	...
	$nome_mes = GetNomeMes( $mes );			// retorna o nome do mês
	$diacorrente = 0;	
	   ...
	   for( $coluna = 0; $coluna < 7; $coluna++ )
	   {
		...
		echo ' align = "center" valign = "center">';
		   ...
		   /* TRECHO IMPORTANTE: A PARTIR DESTE TRECHO É MOSTRADO UM DIA DO CALENDÁRIO (MUITA ATENÇÃO NA HORA DA MANUTENÇÃO) */
			 ...
			 {
			  	 echo "<button type=1button' id = 'dia_comum' name = 'dia".($diacorrente+1)."'  value = '".++$diacorrente."/".$mes."/".$ano."' onclick = 'selecionar(this.value)'>".$diacorrente."</button> ";
